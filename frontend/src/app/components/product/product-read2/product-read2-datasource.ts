...
/**
 * Metodo que faz a conexão entre o dataSource e a tabela ele
 * faz a junção de tudo aquilo que influencia nos dados da tabela , tudo
 * aquilo que vai gerar impacto na renderização da tabela, que é os dados
 * a parte de paginação e o ordenamento dos dados.
...
export class ProductRead2DataSource extends DataSource<Product> {
  ...
  sort: MatSort | undefined; //componente do material que faz a ordenaão dos dados
